...
def plot_gene_expression_vary_gamma_p( # noqa
    gamma_p_list, D0=1, R0=0, P0=0, # noqa
    t_max=100.0, n_ssa=5
): # noqa
    ...
    for j, gamma_p in enumerate(gamma_p_list):
        ...
        R4 = Reaction({2:1}, {}, rate=lambda s, gp=gamma_p: gp) # noqa
    ...
    plt.suptitle("Gene expression: varying protein decay rate γₘ")
    plt.show()
