...
def plot_complex_formation_AB_with_mean(A0, B0, C0, D0, t_max=100.0, n_ssa=5):
    ...
    ssa_interp = np.zeros((n_ssa, len(t_grid), 4))  # A, B, C, D
    ...
    plt.suptitle(f"Protein complex formation\nInitial: A0={A0}, B0={B0}")
...
D0 = 0
t_final = 100.0
plot_complex_formation_AB_with_mean(A0, B0, C0, D0, t_final, n_ssa=5)
